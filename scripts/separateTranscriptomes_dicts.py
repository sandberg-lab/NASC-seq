...
if __name__ == '__main__':
    ...
    nascenttablename = '{}_{}.csv'.format(outname,'newTable')
    print('Saving new reads count table to {}'.format(nascenttablename))
    nascent_df.to_csv(nascenttablename)
    nonnascenttablename = '{}_{}.csv'.format(outname,'oldTable')
    print('Saving old reads count table to {}'.format(nonnascenttablename))
